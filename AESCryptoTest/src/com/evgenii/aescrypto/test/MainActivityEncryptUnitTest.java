...
/*
 * Test ecnryption form main activity
 */
public class MainActivityEncryptUnitTest extends ActivityInstrumentationTestCase2<MainActivity> {
	private MainActivity mActivity;

	public MainActivityEncryptUnitTest() {
